...
$testRecipient = 'nhanakwameotto@gmail.com'
...
npx @insforge/cli db query "UPDATE public.submission_notifications SET official_email='$testRecipient', delivery_status='QUEUED', delivery_error=NULL, updated_at=NOW() WHERE id='$notificationId';"
